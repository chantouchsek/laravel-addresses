...
class Address extends Model
{
    ...
    {
        return $this->belongsTo(config('laravel-address.addresses.users.model', config('auth.providers.users.model', 'App\Models\User')));
    }
    ...
    public static function getValidationRules(): array
    {
        ...
        $rules = config('laravel-address.addresses.rules', $defaultRules);
        $defaultFlags = ['public', 'primary', 'billing', 'shipping'];

        foreach (config('laravel-address.addresses.flags', $defaultFlags) as $flag)
